        ...
        <li data-testid="search-result" data-track-id={result.track.id}>
          ...
          <div class="result-copy">
            <div class="result-heading">
              ...
              {#if index === 0}<span class="best">Best match</span>{/if}
            </div>
...
<style>
  ...
  @media(max-width:767px){.search{--result-art:var(--search-art-mobile)}li{grid-template-areas:"art copy" "actions actions"}.result-actions button{flex:1 1 0;padding-inline:var(--space-2)}}
